...
if($_GET['generated']){
  // ... existing code for displaying the timetable ...

  echo "<br><br>";
  echo "<form method='GET' action='download.php'>";
  echo "<input type='hidden' name='courseid' value='$courseid'>";
  echo "<input type='hidden' name='s' value='$s'>";
  echo"<a href='Timetable.pdf' target='_blank'>View</a><br><br>";
  echo "<a href='download.php?file=Timetable'><input type='submit' value='Download PDF' name='download' class='btn btn-primary' /></a>";
  echo "</form>";
}
